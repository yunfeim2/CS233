...
main:
	...
	li	$a0, 0x2		# test has_single_bit_set (true case)
	jal	has_single_bit_set
	move	$a0, $v0
	jal	print_int_and_space	# this should print 1

	li	$a0, 0x80000000		# test has_single_bit_set (true case)
	jal	has_single_bit_set
	move	$a0, $v0
	jal	print_int_and_space	# this should print 1

	li	$a0, 0xc0000000		# test has_single_bit_set (false case)
	jal	has_single_bit_set
	move	$a0, $v0
	jal	print_int_and_space	# this should print 0
	...
	li	$a0, 0x1		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 0

	li	$a0, 0x00008000		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 15

	li	$a0, 0x00010000		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 0

	li	$a0, 0x00004000		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 14

	li	$a0, 0x0000c000		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 14

	li	$a0, 0x00000003		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 0

	li	$a0, 0x00000006		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 1

	li	$a0, 0x0		# test get_lowest_set_bit 
	jal	get_lowest_set_bit
	move	$a0, $v0
	jal	print_int_and_space	# this should print 0
